...
A simplistic model for salt and pepper noise where the image pixels are replaced by either 255 or 0, that is, 8bit representation of salt and pepper respectively.
...
More noise models and filters to come later, thank you for reading, sh-git-repo